...
variable "ssh_key_name" {
  ...
  default = "kd-impl" #REPLACE
}


variable "db_name" {
  description = "RDS DB name. Make sure there are no hyphens or other special characters in the DB name. Else, DB creation will fail"
  default = "kadunaprd" #REPLACE
}
...
variable "iam_user_arn" {
  default = "arn:aws:iam::022499048165:user/kaduna-prd"
  description = "IAM User ARN for creating kubernetes cluster"
}
